 ...
 * Use the [NpkFragment.newInstance] factory method to
...
class NpkFragment : Fragment() {
    ...
    ): View? {val binding = FragmentNpkBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment NpkFragment.
         */
