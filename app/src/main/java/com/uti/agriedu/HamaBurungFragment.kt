 ...
 * Use the [HamaBurungFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class HamaBurungFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment HamaBurungFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HamaBurungFragment().apply {
