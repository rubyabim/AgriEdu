 ...
 * Use the [FragmentHamaWalang.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentHamaWalang : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentHamaWalangBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentHamaWalang.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentHamaWalang().apply {
