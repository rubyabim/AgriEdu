 ...
 * Use the [BenihSaprotan.newInstance] factory method to
 * create an instance of this fragment.
 */
class BenihSaprotan : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentBenihSaprotanBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment BenihSaprotan.
         */
